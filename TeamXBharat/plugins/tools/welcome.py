...
from TeamXBharat.utils.daxx_ban import admin_filter
...
import asyncio
import time
from TeamXBharat.utils.database import add_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from TeamXBharat.utils.database import get_assistant
import asyncio
from TeamXBharat.misc import SUDOERS
from TeamXBharat.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
from TeamXBharat.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("TeamXBharat/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((635, 635))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('TeamXBharat/assets/font.ttf', size=70)
    welcome_font = ImageFont.truetype('TeamXBharat/assets/font.ttf', size=61)
...
async def greet_new_member(_, member: ChatMemberUpdated):
    ...
    if member.new_chat_member and not member.old_chat_member and member.new_chat_member.status != "kicked":
        ...
        try:
            ...
            pic = "TeamXBharat/assets/upic.png"
